  ...
  _createClass(SqlGenerators, [{
    ...
    value: function generateCase(caseObject, params) {
      ...
      if (caseObject && caseObject.caseOptions) {
        ...
        try {
          for (var _iterator4 = caseObject.caseOptions[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
